...
if ~isempty(dir('sfun_Bacnet.mexw64'))
    delete 'sfun_Bacnet.mexw64';
end

if ~isempty(dir('sfun_Bacnet.mexw64.pdb'))
    delete 'sfun_Bacnet.mexw64.pdb';
end

%mex('-v', '-g',...                 % verbose Output & symbolic information
mex(...
    '-I./Bacnet_stack',...
    '-I./Bacnet_stack/handler',...
